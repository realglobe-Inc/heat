...
class ResNetUNet(nn.Module):
    def __init__(self, n_class, out_dim=None, ms_feat=False):
        ...
        self.layer3 = self.base_layers[6]  # size=(N, 256, x.H/16, x.W/16)
        # self.layer3_1x1 = conv_relu(1024, 1024, 1, 0)
        self.layer4 = self.base_layers[7]  # size=(N, 512, x.H/32, x.W/32)
        # self.layer4_1x1 = conv_relu(2048, 2048, 1, 0)

        self.upsample = nn.Upsample(scale_factor=2, mode="bilinear", align_corners=True)

        self.conv_up3 = conv_relu(1024 + 2048, 1024, 3, 1)
        self.conv_up2 = conv_relu(512 + 1024, 512, 3, 1)
        self.conv_up1 = conv_relu(256 + 512, 256, 3, 1)
        self.conv_up0 = conv_relu(64 + 256, 128, 3, 1)
        # self.conv_up1 = conv_relu(512, 256, 3, 1)
        # self.conv_up0 = conv_relu(256, 128, 3, 1)
